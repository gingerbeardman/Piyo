...
var a={mkCompat:function(d,c,e){if(c){if(c.options.compat_metadata||e){d=a.unMetaDataify(d)
}if(c.options.compat_foreach||e){d=a.unEachify(d)}if(c.options.compat_arrayleft||e){d=a.unArrayOnLeftSideify(d)
}if(c.options.compat_forvarin){d=a.fixForVarXStatements(d)
}}d=d.replace('"use strict"','"use\u00A0strict"');return d
},findPrototypes:function(e){if(e.search(b.escapeForRegExp(".toSource("))!=-1){return true
...
n=r.search(b.escapeForRegExp(l))}return q}};Registry.register("compat",a)
})();